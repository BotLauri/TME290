# Install script for directory: /home/jonas/assignments/6/tme290-lawnmower
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xtme290-lawnmowerx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/jonas/assignments/6/tme290-lawnmower/build/tme290-lawnmower")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/tme290-lawnmower" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/tme290-lawnmower")
...
file(WRITE "/home/jonas/assignments/6/tme290-lawnmower/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
